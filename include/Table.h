...
int subtab [48] = {14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19,
...
int tb2 [64] = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 45, 55, 23,
...
int tb3 [32] = {16, 7,  20,  21, 29,  12,  28,  17, 1, 15, 23, 26,
                5,  18,  31,  10, 2, 8, 24,  14, 32, 27, 3, 9, 19,
                13,  30,   6, 22, 11,  4,  25};

int tb4 [64] = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 45, 55, 23,
                63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53,
                21, 61, 29, 36, 4, 44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51,
               19, 59, 27, 34, 2, 42, 10, 50, 18, 58, 26, 33, 1, 41, 9, 49,
                17, 57, 25};

int expan [48] = {32,	1,	2,	3,	4,	5, 4,	5,	6,	7,	8,	9, 8,	9,
                  10,	11,	12,	13, 12,	13,	14,	15,	16,	17, 16,	17,
